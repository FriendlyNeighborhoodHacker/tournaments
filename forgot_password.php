  ...
  if ($email !== '') {
    try {
      ...
      if ($u) {
        ...
        $html = '<p>You requested to reset your password for '.h(APP_NAME).'.</p>'
        ...
        // Best-effort email; we do not expose success/failure to the user to prevent enumeration
        @send_email($email, 'Password reset for '.APP_NAME, $html, ($u['first_name'].' '.$u['last_name']));
      }
